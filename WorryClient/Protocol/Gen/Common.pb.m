...
BOOL PBDeviceTypeIsValidValue(PBDeviceType value) {
  switch (value) {
    case PBDeviceTypeIos:
    case PBDeviceTypeAndroid:
    case PBDeviceTypeWindowsPhone:
      return YES;
    default:
      return NO;
  }
...
NSString *NSStringFromPBDeviceType(PBDeviceType value) {
  switch (value) {
    case PBDeviceTypeIos:
      return @"PBDeviceTypeIos";
    case PBDeviceTypeAndroid:
      return @"PBDeviceTypeAndroid";
    case PBDeviceTypeWindowsPhone:
      return @"PBDeviceTypeWindowsPhone";
    default:
      return nil;
  }
}
